  ...
  return (
    <section id="newsletter-signup-section" className="py-20 bg-[#F5EFEB] relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#2C221E] text-[#FBF8F3] rounded-3xl p-8 sm:p-12 lg:p-16 relative overflow-hidden shadow-2xl border border-[#D98246]/20">
          ...
          <div className="relative z-10 max-w-2xl mx-auto text-center space-y-6">
            ...
            <p className="text-sm sm:text-base text-[#D5C7BD] leading-relaxed">
            ...
            {subscribed ? (
              <div className="bg-[#2F4839]/80 border border-emerald-500/30 p-6 rounded-2xl animate-in fade-in zoom-in duration-300 text-center space-y-2">
                ...
                <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3.5 rounded-xl bg-white/10 border border-white/20 text-white placeholder-[#9C8B82] text-sm focus:outline-none focus:ring-2 focus:ring-[#D98246] focus:bg-white/15 transition-all"
                    />
                  </div>
                  <button
                    id="newsletter-subscribe-btn"
                    type="submit"
                    className="px-6 py-3.5 bg-[#9E5328] hover:bg-[#B86B35] text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-2 shrink-0 group"
                  >
                    <span>Subscribe</span>
            ...
            <div className="flex items-center justify-center gap-6 pt-2 text-[11px] text-[#8C7A70]">
              <span className="flex items-center gap-1">
                <ShieldCheck className="w-3.5 h-3.5 text-[#D98246]" />
                Zero spam, strictly harvest updates
              </span>
              <span>•</span>
